...
public class printfDefi extends FunctionDefi {
    ...
    public printfDefi() {
        super(new IntType(), new Symbol("printf"), (new DeclList()).add(new VariableDecl(new PointerType(new CharType()), new Symbol("argu"), null)), new CompoundStat(new DeclList(), new StatList()));
